...
class Ui_Dialog(object):
    ...
    def retranslateUi(self, Dialog):
        ...
        self.groupBox.setTitle(_translate("Dialog", "Welcome Back!"))
        self.label_user.setText(_translate("Dialog", " Username"))
        self.label_pass.setText(_translate("Dialog", " Password "))
        self.pushButton_cancel.setText(_translate("Dialog", "Cancel"))
        self.pushButton_newUser.setText(_translate("Dialog", "New User"))
