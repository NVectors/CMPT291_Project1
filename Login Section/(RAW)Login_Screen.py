...
class Ui_Dialog_Login(object):
    def setupUi(self, Dialog_Login):
        ...
        icon = QtGui.QIcon()
        icon.addPixmap(QtGui.QPixmap(":/newPrefix/home_icon.png"), QtGui.QIcon.Normal, QtGui.QIcon.On)
        ...
        self.label_background = QtWidgets.QLabel(Dialog_Login)
        self.label_background.setGeometry(QtCore.QRect(-250, -70, 961, 661))
        self.label_background.setStyleSheet("image:url(:/newPrefix/login_background.jpg)")
