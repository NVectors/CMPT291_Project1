...
"")
    ...
    def retranslateUi(self, Dialog):
        ...
        self.groupBox.setTitle(_translate("Dialog", "Register as New User"))
        self.label.setText(_translate("Dialog", " Confirm Password "))
        self.checkBox.setText(_translate("Dialog", " Agent "))
        self.checkBox_2.setText(_translate("Dialog", " Officer"))
        self.label_firstName.setText(_translate("Dialog", " First Name "))
        self.label_userCity.setText(_translate("Dialog", " City"))
        self.label_rPass.setText(_translate("Dialog", " Password"))
        self.label_lastName.setText(_translate("Dialog", " Last Name"))
        self.label_rUser.setText(_translate("Dialog", " Username "))
        self.label_userType.setText(_translate("Dialog", " Type"))
        self.pushButton_rcancel.setText(_translate("Dialog", "Cancel"))
